		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li><a href="<?php echo base_url()."c_crud/add_data/"; ?>">Tambah Artikel</a></li>
				...
				<div class="row animate-box" data-animate-effect="fadeInLeft">
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item">
						<a href="<?php echo base_url()."c_crud/do_preview/".$d['id']; ?>">
							<img src="<?php echo base_url('images/'.$d['gambar']); ?>" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
