            ...
            <div class="portfolio-inner">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps">
                        <div class="item">
                            <a href="assets/images/portfolio/1.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix mockups">
                        <div class="item">
                            <a href="assets/images/portfolio/2.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps">
                        <div class="item">
                            <a href="assets/images/portfolio/3.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix mockups wordpress">
                        <div class="item">
                            <a href="assets/images/portfolio/4.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix wordpress apps">
                        <div class="item">
                            <a href="assets/images/portfolio/5.jpg" class="portfolio-popup" title="Project Title">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 mix apps mockups wordpress" title="Project Title">
                        <div class="item">
                            <a href="assets/images/portfolio/6.jpg" class="portfolio-popup">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="testimonial-carousel-list margin-top-20">
                    ...
                    <img src="assets/images/testimonial/1.png" class="img-responsive" alt="">
                        <h2>John doe</h2>
                    ...
                    <div class="testimonial-word text-center">
                    <img src="assets/images/testimonial/2.png" class="img-responsive" alt="">
                        <h2>John doe</h2>
                        <p>quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duisauteiruredolor in reprehenderit in voluptate.</p>
                    </div>
                    
                    <div class="testimonial-word text-center">
                    <img src="assets/images/testimonial/3.png" class="img-responsive" alt="">
                        <h2>John doe</h2>
                        <p>quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duisauteiruredolor in reprehenderit in voluptate.</p>
                    </div>
